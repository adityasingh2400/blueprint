...
import { DownloadIcon, HomeIcon, PlayFilledIcon, PlayIcon } from "@blueprintjs/icons/next";
...
export const DynamicString: Story = {
    ...
    render: () => (
        <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
            <IconNext icon="home" size={32} />
            <IconNext icon="download" size={32} />
            <IconNext icon="star" size={32} />
            <IconNext icon="cog" size={32} />
            <IconNext icon="search" size={32} />
        </div>
    ),
};
...
export const ElementPassthrough: Story = {
    ...
    render: () => (
        <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
            <IconNext icon={<HomeIcon size={32} />} />
            <IconNext icon={<DownloadIcon size={32} />} />
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            <div>
                ...
                <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
                    ...
                    <IconNext icon="volume-up" size={32} />
                    <IconNext icon="fast-forward" size={32} />
                    <IconNext icon="step-backward" size={32} />
                </div>
            </div>
            <div>
                ...
                <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
                    ...
                    <IconNext icon="volume-up" variant="filled" size={32} />
                    <IconNext icon="fast-forward" variant="filled" size={32} />
                    <IconNext icon="step-backward" variant="filled" size={32} />
                </div>
            </div>
        </div>
    ),
...
export const FilledFallback: Story = {
    ...
    render: () => (
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            ...
            <div>
                <StoryLabel title="No filled variant (download) — falls back to outlined" />
                <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
                    <IconNext icon="download" size={32} />
                    <IconNext icon="download" variant="filled" size={32} />
                </div>
            </div>
        </div>
    ),
